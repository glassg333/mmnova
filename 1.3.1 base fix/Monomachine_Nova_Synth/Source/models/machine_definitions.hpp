...
inline const std::vector<MachineDef>& getAllMachineDefinitions() {
    static const std::vector<MachineDef> kMachines = {
        ...
        {
            7, "DPRO", "DPRO-MOD", false,
            {{
                {"PTCH", "Pitch / Timbre tune", 0, 127, 64}, {"STRT", "Sample start / decay stretch", 0, 127, 0},
                {"MODE", "Source: sample slot or OSC", 0, 1, 0}, {"SLOT", "Sample slot / OSC timbre", 0, 9, 0},
                {"RTRG", "Retrigger Count", 0, 127, 0}, {"RTIM", "Retrigger Time", 0, 127, 0},
                {"RSTR", "Random start on note", 0, 1, 0}, {"LEV", "Sample level", 0, 127, 127}
            }}
        },
        {
