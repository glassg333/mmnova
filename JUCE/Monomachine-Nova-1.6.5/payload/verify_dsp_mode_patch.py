...
def main() -> int:
    ...
    present(text, "case DspFilter: return \"FILT: mnm = настоящий фильтр",
    ...
    present(text, "inL * send + fbL * feedback", "1.6.5 MnmDelay: в линию пишется вход*send")
    ...
    present(text, "BUILD 1.6.5", "1.6.5 Editor: маркер версии")
