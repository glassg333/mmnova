...
inline const std::vector<MachineDef>& getAllMachineDefinitions() {
    static const std::vector<MachineDef> kMachines = {
        ...
        },
        {
            ...
            {{
                {"ST", "Stereo Spread", 0, 127, 64}, {"RED", "Keytracked noise contour", 0, 127, 0},
                {"STON", "Stereo Noise", 0, 1, 0}, {"TIME", "Noise envelope time offset", 0, 127, 64},
                {"BIT", "Sample rate reduction", 0, 127, 0}, {"---", "Unused", 0, 0, 0},
        ...
        // SWAVE Family
        {
            ...
            {{
                ...
                {"UNIX", "Extended unison level", 0, 127, 0}, {"MODE", "Saw algorithm", 0, 1, 1},
                {"SUBX", "Dirty sub level", 0, 127, 0}, {"SUB1", "Sine sub 1 level", 0, 127, 0},
                {"SUB2", "Sine sub 2 level", 0, 127, 0}, {"TUNE", "Oscillator Tune", 0, 127, 64}
            }}
        },
        {
        ...
        // FX Family (Effects). Parameter sets follow the OS 1.32B machine descriptors:
        // REVERB: DEC DAMP GATE MIX HP LP INP | CHORUS: DEL DEP SPD MIX FB WID LP INP
        // DYNAMIX: ATK REL THRS MIX RAT GAIN RMS INP | PHASER: CNTR DEP SPD MIX FB WID INP
        // FLANGER: DEL DEP SPD MIX FB WID INP. INP is input gain, not channel routing.
        {
            12, "FX", "FX-THRU", true,
            {{
                {"---", "Unused", 0, 0, 0}, {"---", "Unused", 0, 0, 0},
                {"---", "Unused", 0, 0, 0}, {"---", "Unused", 0, 0, 0},
                {"---", "Unused", 0, 0, 0}, {"---", "Unused", 0, 0, 0},
                {"---", "Unused", 0, 0, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                ...
                {"HP", "Input high-pass", 0, 127, 0}, {"LP", "Wet low-pass", 0, 127, 127},
                {"---", "Unused", 0, 0, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                {"DEL", "Chorus Base Delay", 0, 127, 64}, {"DEP", "LFO Modulation Depth", 0, 127, 64},
                {"SPD", "LFO Rate / Speed", 0, 127, 64}, {"MIX", "Wet/Dry Balance", 0, 127, 0}, // 1.8.1b: MIX=0 -- юзер подмешивает сам
                {"FB", "Feedback", 0, 127, 0}, {"WID", "Stereo Width", 0, 127, 0},
                {"LP", "Feedback Low-pass", 0, 127, 127}, {"INP", "Input gain", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                ...
                {"RMS", "Peak vs RMS Detection", 0, 127, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                ...
                {"TUNE", "Ring carrier MIDI pitch", 0, 127, 60}, {"MIX", "Wet/Dry Balance", 0, 127, 127},
                {"---", "Unused", 0, 0, 0}, {"---", "Unused", 0, 0, 0},
                {"---", "Unused", 0, 0, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                ...
                {"FB", "Feedback", 0, 127, 0}, {"WID", "Stereo Phase Spread", 0, 127, 64},
                {"---", "Unused", 0, 0, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        },
        {
            ...
            {{
                ...
                {"FB", "Feedback", 0, 127, 95}, {"WID", "Stereo Width Spread", 0, 127, 64},
                {"---", "Unused", 0, 0, 0}, {"INP", "FX input gain (64 = unity)", 0, 127, 64}
            }}
        }
    };
