...
void ChorusCore::setParametersF(const std::array<float,8>& p) noexcept {
 for(unsigned i=0;i<8;++i) { const float v=p[i]<0.f?0.f:(p[i]>127.f?127.f:p[i]); y[0x52c+i]=Word(v*65536.0f)&0xffffffu; }
}
