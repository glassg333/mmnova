...
inline constexpr int kDspModeSchemaVersion = 11;
...
inline const char* dspSectionModeChoices(int section) {
    switch (section) {
        case DspSynt:    return "mnm|old";   // synt: firmware FmCore, reserve = previous Nova FM
        case DspAmp:     return "mnm|old";   // amplitude: kernel ADSR tables
