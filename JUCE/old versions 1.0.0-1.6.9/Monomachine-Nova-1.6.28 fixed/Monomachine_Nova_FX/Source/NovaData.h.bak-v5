...
inline const std::vector<Spec>& specs() {
    static const std::vector<Spec> all=[] {
        ...
        // DSP mode lists (1.6.0). Entry 0 is always "mnm" (recovered OS 1.32B firmware DSP)
        // and is the default; entry 1 is "old", the previous Nova algorithm, kept for A/B.
        // Legacy states without these parameters are migrated to "old" -- see PluginProcessor.
