...
public: // 1.6.29: страницы MSEG (сколько видно в списке редактора и матрице)
    int msegPageCount() const noexcept { return juce::jlimit(1,8,msegPages.load()); }
    void setMsegPageCount(int n) noexcept { msegPages.store(juce::jlimit(1,8,n)); }
