...
public:
    ...
    static constexpr size_t kTargetCount = 64; // 8 synth + 8 AMP + 8 FILT + 8 FX + 24 LFO + 8 MSEG OUT (56..63, 1.6.29)
    ...
    void evaluate(const std::array<T, N>& baseParams, std::array<T, N>& modulatedParams, float* msegDests = nullptr) const noexcept {
