...
public:
    ...
    void setParameters(float cntr, float dep, float spd, float mix, float fb, float wid) {
        m_cntrParam = cntr;
        m_depParam = dep;
        m_spdParam = spd;
        m_mixParam = mix;
...
public:
    ...
    void setParameters(float del, float dep, float spd, float mix, float fb, float wid) {
        m_delParam = del;
        m_depParam = dep;
        m_spdParam = spd;
        m_mixParam = mix;
...
public:
    ...
    void setParameters(float wave, float ext, float mix, float tuneMidiPitch) {
        m_waveParam = wave;
        m_extParam = ext;
        m_wetMix = mix / 127.0f;
