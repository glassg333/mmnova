...
public:
    ...
    static constexpr size_t kTargetCount = 131; // 1.7.7: 67..130 = ROUTE 1..64 (глубина любого из 64 слотов) // 1.7.5: +PITCH (66) + ROUTE 1..16 (67..82) -- модуляция глубины соседних маршрутов
