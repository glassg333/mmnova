...
REPO_DD = os.path.join(_find_repo_root(), "decompiled data")
DIS = os.path.join(REPO_DD, "07_scripts", "DSP56300 disassemblerStandalone", "scripts", "dis56300.py")
PM = os.path.join(REPO_DD, "02_memory_images", "dsp1_pmem.bin")
