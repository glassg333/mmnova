...
int main() {
    ...
    // DYN 1VEN selector edges (knobs 25/26, 51/52, ...)
    CHECK(dynVenCurve(25) == 0 && dynVenCurve(26) == 1, "ven edge 25/26");
    CHECK(dynVenCurve(76) == 2 && dynVenCurve(77) == 3, "ven edge 76/77");
    CHECK(dynVenCurve(103) == 4, "ven edge 103");
