...
## 9 ГРАНИЦ СТАДИЙ POST-VOICE
  ...
  Промежуточные стерео-буферы: X:$0097..$00A6 (L), X:$00D7..$00E6 (R).
  Финальный выход трека @ P:$0B14: X:$0000..$000F (L), Y:$0020..$002F (R).

## ЧТО ОСТАЛОСЬ
Только опкоды внутри этих 9 интервалов (как именно Y:$50A/Y:$50B
превращаются в два слота Y:$91+, и в каком из интервалов $06C0..$0A5B
стоит DIST = Y:$504). Теперь известны точные адреса и переменных,
и границ кода — искать вслепую больше не надо.
