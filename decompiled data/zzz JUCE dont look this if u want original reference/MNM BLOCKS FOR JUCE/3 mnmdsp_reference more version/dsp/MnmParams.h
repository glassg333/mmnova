// ============================================================================
// MnmParams.h — ПОЛНАЯ карта ручек всех машин Monomachine OS 1.32B.
// Сгенерировано из дескрипторов ColdFire (coldfire_main.bin @0x57FC5, шаг 0xB0).
...
// Значения на DSP приходят УЖЕ отмасштабированными ColdFire'ом в слово Q1.23
// (кривые — на стороне ColdFire, см. docs/ROUTING_RU.md §скейлинг).
// ============================================================================
#pragma once
#include <cstdint>
...
static constexpr MachineParams kMachines[] = {
...
static constexpr int kMachineCount = sizeof(kMachines)/sizeof(kMachines[0]);
